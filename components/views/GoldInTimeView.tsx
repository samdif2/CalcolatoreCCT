  ...
  return (
    <div className="p-4 space-y-6">
      <div className="flex items-center justify-center space-x-3">
        <h2 className="text-2xl font-bold text-[#D4AF37]">Gold in Time</h2>
      ...
      <div className="bg-white p-4 rounded-lg shadow-sm">
        <div className="grid grid-cols-1 md:grid-cols-2 landscape:grid-cols-2 gap-4 items-center">
          ...
          <div className="flex items-center space-x-4">
            <label htmlFor="capital-time" className="text-sm font-medium text-gray-700 whitespace-nowrap">Accumulo annuale</label>
            <input
              type="text"
              inputMode="numeric"
              id="capital-time"
      ...
      <div id="pdf-export-area-time" className="space-y-6">
        ...
        <div className="bg-[#D4AF37] text-white p-6 rounded-lg shadow-lg text-center">
            ...
            <p className="text-sm opacity-90">{formatCurrency(totalInvestedCapital)} (Accumulo annuale) + {formatCurrency(totalRevenue)} (Ricavi)</p>
        </div>
